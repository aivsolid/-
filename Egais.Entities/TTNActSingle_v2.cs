...
namespace Egais.Entities.TTNActSingle_v2 {
    ...
    [System.Xml.Serialization.XmlRootAttribute(Namespace="http://fsrar.ru/WEGAIS/ActTTNSingle_v2", IsNullable=true)]
    [System.Runtime.Serialization.DataContractAttribute(Name="WayBillActType_v2", Namespace="http://fsrar.ru/WEGAIS/ActTTNSingle_v2")]
    public partial class WayBillActType_v2 : System.ComponentModel.INotifyPropertyChanged {
        ...
        public WayBillActType_v2() {
            this.contentField = new List<PositionType>();
            this.headerField = new WayBillActType_v2Header();
        }
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(WayBillActType_v2));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current WayBillActType_v2 object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an WayBillActType_v2 object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output WayBillActType_v2 object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out WayBillActType_v2 obj, out System.Exception exception) {
            exception = null;
            obj = default(WayBillActType_v2);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out WayBillActType_v2 obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static WayBillActType_v2 Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((WayBillActType_v2)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current WayBillActType_v2 object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an WayBillActType_v2 object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output WayBillActType_v2 object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out WayBillActType_v2 obj, out System.Exception exception) {
            exception = null;
            obj = default(WayBillActType_v2);
            try {
        ...
        public static bool LoadFromFile(string fileName, out WayBillActType_v2 obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static WayBillActType_v2 LoadFromFile(string fileName) {
    ...
    [System.SerializableAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true, Namespace="http://fsrar.ru/WEGAIS/ActTTNSingle_v2")]
    [System.Runtime.Serialization.DataContractAttribute(Name="WayBillActType_v2Header", Namespace="http://fsrar.ru/WEGAIS/ActTTNSingle_v2")]
    public partial class WayBillActType_v2Header : System.ComponentModel.INotifyPropertyChanged {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(WayBillActType_v2Header));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current WayBillActType_v2Header object into an XML document
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize() {
            System.IO.StreamReader streamReader = null;
        ...
        /// <summary>
        /// Deserializes workflow markup into an WayBillActType_v2Header object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output WayBillActType_v2Header object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out WayBillActType_v2Header obj, out System.Exception exception) {
            exception = null;
            obj = default(WayBillActType_v2Header);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out WayBillActType_v2Header obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static WayBillActType_v2Header Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((WayBillActType_v2Header)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
                if ((stringReader != null)) {
                    stringReader.Dispose();
        ...
        /// <summary>
        /// Serializes current WayBillActType_v2Header object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an WayBillActType_v2Header object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output WayBillActType_v2Header object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out WayBillActType_v2Header obj, out System.Exception exception) {
            exception = null;
            obj = default(WayBillActType_v2Header);
            try {
                obj = LoadFromFile(fileName);
        ...
        public static bool LoadFromFile(string fileName, out WayBillActType_v2Header obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static WayBillActType_v2Header LoadFromFile(string fileName) {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try {
                file = new System.IO.FileStream(fileName, FileMode.Open, FileAccess.Read);
    ...
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://fsrar.ru/WEGAIS/ActTTNSingle_v2")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace="http://fsrar.ru/WEGAIS/ActTTNSingle_v2", IsNullable=false)]
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://fsrar.ru/WEGAIS/ActTTNSingle_v2")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace="http://fsrar.ru/WEGAIS/ActTTNSingle_v2", IsNullable=true)]
    [System.Runtime.Serialization.DataContractAttribute(Name="PositionType", Namespace="http://fsrar.ru/WEGAIS/ActTTNSingle_v2")]
